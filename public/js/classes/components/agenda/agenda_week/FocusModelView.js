export class FocusModalView {
    ...
    renderMobile(task) {
        ...
        labelTime.setAttribute("for", "timeSelect");
        labelTime.textContent = "Time";

        const inputTime = document.createElement("input");
        inputTime.setAttribute("type", "time");
        inputTime.setAttribute("name", "scheduled_time");
        inputTime.setAttribute("id", "timeSelect");
        ...
        form.append(divName, divDesc, divType, divTime, btnSubmit);
    ...
    render(task) {
        ...
        form.append(nameDiv, descDivForm, typeDiv, divTime, submitBtn);
        footer.appendChild(form);
    ...
    renderSpaceRepetition(task) {
        ...
        el.innerHTML = `
            ...
            <button class="btn-mini mutatedRed btn-reviewTomorow btn">Review Tomorrow </button> 
